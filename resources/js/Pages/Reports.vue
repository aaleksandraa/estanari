    ...
    <MainLayout>
        ...
        <div class="p-6 space-y-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div class="rounded-xl border border-gray-200 bg-white p-6 hover:shadow-md transition-shadow">
                    <div class="flex items-start justify-between mb-4">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">{{ __('daily_report') }}</h3>
                            <p class="text-sm text-gray-500 mt-1">{{ __('daily_report_desc') }}</p>
                        </div>
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('select_date') }}</label>
                    ...
                    <button @click="downloadDaily" class="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700">
                        <TableCellsIcon class="h-4 w-4" /> {{ __('download_excel') }}
                    </button>
                </div>
                ...
                <div class="rounded-xl border border-gray-200 bg-white p-6 hover:shadow-md transition-shadow">
                    <div class="flex items-start justify-between mb-4">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">{{ __('monthly_report') }}</h3>
                            <p class="text-sm text-gray-500 mt-1">{{ __('monthly_report_desc') }}</p>
                        </div>
                    ...
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-1">{{ __('select_month') }}</label>
                ...
                <div class="rounded-xl border border-gray-200 bg-white p-6 hover:shadow-md transition-shadow">
                    <div class="flex items-start justify-between mb-4">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">{{ __('by_supplier_report') }}</h3>
                            <p class="text-sm text-gray-500 mt-1">{{ __('by_supplier_report_desc') }}</p>
                        </div>
                        <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-purple-100">
                            <ChartPieIcon class="h-5 w-5 text-purple-600" />
                        </div>
                    </div>
                    <p class="text-xs text-gray-400 mb-4">{{ __('includes_all_suppliers') }}</p>
                ...
                <div class="rounded-xl border border-gray-200 bg-white p-6 hover:shadow-md transition-shadow">
                    <div class="flex items-start justify-between mb-4">
                        <div>
                            <h3 class="text-lg font-semibold text-gray-900">{{ __('by_currency_report') }}</h3>
                            <p class="text-sm text-gray-500 mt-1">{{ __('by_currency_report_desc') }}</p>
                        </div>
                        <div class="flex h-10 w-10 items-center justify-center rounded-lg bg-amber-100">
                            <DocumentTextIcon class="h-5 w-5 text-amber-600" />
                        </div>
                    </div>
                    <p class="text-xs text-gray-400 mb-4">{{ __('excel_with_sheets') }}</p>
            ...
            <div class="rounded-xl border-2 border-dashed border-gray-300 bg-gray-50 p-8 text-center">
                ...
                <h3 class="font-medium text-gray-900 mb-2">{{ __('professional_excel_reports') }}</h3>
                <p class="text-sm text-gray-500 max-w-md mx-auto">
                    {{ __('reports_description') }}
                </p>
            </div>
        </div>
    </MainLayout>
